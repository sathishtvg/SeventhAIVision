...
import {
  Box, Button, CircularProgress, TextField, Typography, Alert, InputAdornment, Link,
} from '@mui/material'
...
export default function ForgotPassword() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null)
    try {
      await forgotPassword(tenantSlug.trim(), email.trim())
      setSubmitted(true)
    } catch {
      // Backend returns an identical shape whether the account exists or not,
      // so a network/5xx failure is the only realistic error path here.
      ...
      >
        ...
        >
          ...
          <Box sx={{ p: 4 }}>
            ...
            {submitted ? (
              <>
                <Alert severity="success" sx={{ mb: 2.5, fontSize: '0.82rem' }}>
                ...
                <Link
                  ...
                  sx={{
                    ...
                    color: accentColor, fontSize: '0.82rem', textDecoration: 'none',
              ...
              <>
                <Typography variant="body2" sx={{ color: 'text.secondary', mb: 3, fontSize: '0.82rem' }}>
                  Enter your organisation slug and email — we'll send you a link to reset your password.
                </Typography>
