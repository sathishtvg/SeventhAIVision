...
export const PAGE_LABELS = {
  ...
  'man-down': { title: 'Man Down', subtitle: 'Guards whose phone says they have stopped moving, and who is going to look' },
  ...
  'my-patrols': { title: 'My Patrols', subtitle: 'Patrols assigned to you — capture the camera, answer the checks, move on' },
  ...
  'certification-compliance': { title: 'Certification Compliance', subtitle: 'Upcoming shifts whose guard does not hold what the site requires — checked against the day they work, not today' },
